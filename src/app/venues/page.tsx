...
export default function VenuesPage() {
  ...
  return (
    <div className="min-h-screen text-[#1C3658]">
      ...
      {/* Mapa */}
      <section className="relative w-full h-[450px] grayscale">
        <iframe
  ...
  {venues.map((v) => (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-lg">
          Perfect for young adventurers, Altitude Trampoline Park – Katy brings trampoline, active, indoor experiences to families in Katy.
        </p>

        {/* Contenedor para los botones */}
        <div className="flex gap-4 pt-4">
          <button className="bg-blue-600 text-white px-4 py-2 rounded">View Profile</button>
          <button className="bg-blue-600 text-white px-4 py-2 rounded">Check availability/Book</button>
        </div>
      </div>
    </div>
  ))}
  ...
  <div className="flex justify-center space-x-2 pt-8">
    <button className="bg-[#0E2A47] text-white px-3 py-1 rounded-full">1</button>
    <button className="bg-white text-[#0E2A47] px-3 py-1 rounded-full">2</button>
    <button className="bg-white text-[#0E2A47] px-3 py-1 rounded-full">3</button>
    <button className="bg-white text-[#0E2A47] px-3 py-1 rounded-full">&rarr;</button>
  </div>
</section>
      </div>
    </div>
