    ...
    <div className="text-[#1C3658] min-h-screen">
      ...
      <div className="py-44 px-40 mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-1 space-y-6">
          <h1 className="text-4xl font-bold">Altitude Trampoline Park – Katy</h1>
          ...
          <p className="">
            Perfect place for kids to explore energetic activities in a safe and fun environment. Altitude Trampoline Park – Katy brings fun to life.
          </p>

          {/* Countdown */}
          <div className="font-bold">
            Hurry up! Deal ends in: <span className="bg-white text-black px-2 py-1 rounded">300d : 18h : 35m : 50s</span>
          </div>
          ...
          <div className="mt-6">
            <Image src="/img/payment-methods.png" alt="Payments" width={200} height={30} />
          </div>

          {/* Tabs */}
          <div className="mt-10 flex gap-4">
            <button className="bg-[#0E2A47] text-white px-4 py-2 rounded-full">Description</button>
            <button className="bg-white text-black px-4 py-2 rounded-full">Additional Info</button>
            <button className="bg-white text-black px-4 py-2 rounded-full">Reviews (3)</button>
          </div>
        </div>
      </div>
