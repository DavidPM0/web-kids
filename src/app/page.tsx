...
/>
          ...
          <p className="text-lg text-gray-200">
            Discover, Compare, And Book Top-Rated Birthday Venues In Houston — All In One Place. Whether It’s Unicorns, Dinosaurs, Or Bounce Castles, BashWish Makes It Easy.
          </p>
          <button>
            Browse Venue
          </button>
...
<section className="bg-[#1C3658] py-8 overflow-hidden whitespace-nowrap relative">
  <div className="animate-marquee text-white text-3xl font-semibold px-6">
    ...
    Currently available in Houston. More cities coming soon!<span className="text-yellow-400 mr-1">⭐</span>
    Currently available in Houston. More cities coming soon!<span className="text-yellow-400 mr-1">⭐</span>
    Currently available in Houston. More cities coming soon!<span className="text-yellow-400 mr-1">⭐</span>
    Currently available in Houston. More cities coming soon!<span className="text-yellow-400 mr-1">⭐</span>
...
<section className="pt-44 px-6 md:px-20 lg:px-40">
  <div className="mx-auto">
    <Image
          ...
          />
    <h2 className="text-4xl font-bold text-[#1C3658] mb-6 text-center">How old is your kid?</h2>
...
<section className="py-44 px-40">
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    {[
      { name: "Funny Key Operated Bee Toy", old: 80, new: 50, img: "/proct.jpg" },
      { name: "Mix Kids Cube Toys", old: 60, new: 50, img: "/proct.jpg" },
      { name: "Revolving New Hot 007 JCB", old: 80, new: 50, img: "/proct.jpg" },
      { name: "Power Ranger Talwar Toy", old: 80, new: 50, img: "/proct.jpg" },
    ].map((product, idx) => (
      <div
        key={idx}
...
/>
        <h3 className="text-xl font-semibold text-[#1C3658]">{product.name}</h3>
        <p className="text-lg text-[#1C3658]">Location: Katy</p>
        <p className="text-gray-600 line-through">${product.old}.00</p>
        <p className="text-2xl text-[#1C3658] font-bold">${product.new}.00</p>
      </div>
    ))}
  </div>
  {/* Botón final */}
...
<section className="text-center pt-0 pb-44 px-40">
  <Image
            ...
            className="object-cover mx-auto mb-6"
          />
  <h2 className="text-4xl font-bold text-[#1C3658] mb-6">Our Testimonial</h2>
  <p className="text-lg text-[#1C3658] max-w-xl mx-auto mb-14">
    Phasellus Sem Lorem, Blandit Vitae Lucus Ac, Sodales Bibendum Sapien. In Sodales Vestibulum Quam.
  </p>

  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    {[
      { name: "Jessika Lisa", role: "Fashion Designer", color: "bg-[#1C3658]" },
      { name: "Kimberly", role: "Fashion Designer", color: "bg-[#F8BD36]" },
      { name: "Amanda Carol", role: "Fashion Designer", color: "bg-[#1C3658]" },
      { name: "Kimberly", role: "Fashion Designer", color: "bg-[#F8BD36]" },
    ].map((item, idx) => (
      <div
        key={idx}
      ...
      >
        ...
        <p className="text-lg mb-4">
          “Excellent service and great collection. My kid loves every product we bought here!”
        </p>
        <img
          src="/av-girl.png"
          alt="Kids Group"
      ...
      <section className="pt-0 pb-44 px-40 text-center">
        ...
        <p className="text-lg text-[#1C3658] mb-14 max-w-xl mx-auto">
          Etiam placerat, nisi ut porta fermentum, vestibulum ut sodales quam, ut iaculis augue.
        </p>
...
<section className="relative pt-44 pb-44">
  ...
  <div className="absolute inset-0 bg-[#1C3658] bg-[url('/dots.png')] bg-cover z-0" style={{ height: 'calc(100% - 350px)' }}/>
